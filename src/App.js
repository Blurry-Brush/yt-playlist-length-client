...
function App() {
  ...
  return (
    <div className="bg-gray-700 h-screen overflow-y-hidden">
      <header className="w-full bg-black/50 px-4 py-4 flex items-center justify-between lg:justify-center lg:space-x-20">
        <h1 className="text-xl text-white/70 font-sans">
          Youtube Playlist Length Calculator
        </h1>
        <FaYoutube
          className="hover:animate-spin duration-200 ease-in-out"
          color="red"
          size={40}
        />
      </header>
      ...
      <div className="px-4">
        <div className="pt-10  lg:pt-28 mx-auto max-w-3xl">
          <form
          ...
          {apidata && (
            <div className="bg-white h-fit rounded mt-12 lg:mt-24 p-4 w-full">
      ...
      <footer className=" absolute bottom-0  w-full bg-black/50 px-4 py-4 flex items-center justify-between lg:justify-center lg:space-x-20">
        <h1 className="text-white/60 font-normal text-lg">
          {" "}
        ...
        <div className="flex space-x-4">
          <a
            ...
            href="https://github.com/Blurry-Brush"
          >
            {" "}
            <FaGithub color="#472183" size={30} />{" "}
          </a>
          <a
            className="hover:scale-105 duration-300 ease-in-out"
            href="https://www.instagram.com/yuwuxj/"
          >
            {" "}
            <FaInstagram color="#CB1C8D" size={30} />{" "}
          </a>
        </div>
      </footer>
    </div>
